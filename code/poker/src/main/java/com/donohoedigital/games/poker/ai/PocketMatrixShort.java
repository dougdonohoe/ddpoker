...
/**
 * Encapsulates tight storage of short values for every possible pocket.
 */
public class PocketMatrixShort
{
    private static final int SZ = 1326; // 52 choose 2

    private short[] data_ = new short[SZ];

    public PocketMatrixShort()
    {
        this((short)0);
    }

    public PocketMatrixShort(short v)
    {
        clear(v);
    }

    /**
     * Sets all the shorts in the matrix to the same value.
     */
    public void clear(short v)
    {
     ...
     */
    public void set(Hand h, short v)
    {
     ...
     */
    public void set(Card i, Card j, short v)
    {
     ...
     * Sets the value corresponding to a particular pair of cards.
     */
    public void set(int i, int j, short v)
    {
     ...
     */
    public short get(Card i, Card j)
    {
