...

{
    ...
    public void setInputMode(int nMode, HoldemHand hhand, PokerPlayer player)
    {
        ...
        // get fold check pref
        boolean bFoldCheck = GameEngine.getGameEngine().getPrefsNode().getBooleanOption(PokerConstants.OPTION_CHECKFOLD);
...
//    }
    ...
    protected boolean handleKeyPressed(KeyEvent event)
    {
        ...
        boolean bDisableShortcuts = GameEngine.getGameEngine().getPrefsNode().getBooleanOption(PokerConstants.OPTION_DISABLE_SHORTCUTS);
    ...
    private class PokerGamePieceListener implements GamePieceSelectionListener
    {
        ...
        private void checkCard(Gameboard g, EngineGamePiece gp, boolean bVisible)
        {
            if (gp instanceof CardPiece)
            {
                ...
                boolean bHoleFaceDown = engine.getPrefsNode().getBooleanOption(PokerConstants.OPTION_HOLE_CARDS_DOWN);
    ...
    public boolean allowTerritorySelection(Territory t, MouseEvent e)
    {
        return GuiUtils.isPopupTrigger(e,
                                       !engine_.getPrefsNode().getBooleanOption(PokerConstants.OPTION_RIGHT_CLICK_ONLY));
    }
