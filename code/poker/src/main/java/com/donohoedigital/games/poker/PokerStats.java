...
{
    static Logger logger = LogManager.getLogger(PokerStats.class);
    ...
    private ArrayList stats_ = new ArrayList();
    private int SEATS = PokerConstants.SEATS;
    ...
    private void results()
    {
        ...
        for (int i = 0; i < hhand_.getNumPlayers(); i++)
        {
            ...
            if (DEBUG)
            {
                ...
                if (nAmount > 0)
                {
                    sResult += " WIN " + new Integer(nAmount);
                }
    ...
    public static void main(String args[])
    {
        ...
        if (args.length < 2) 
        {
            System.out.println("PokerStats [loops]");
            System.exit(-1);
        }
        ...
        // get number of runs before remembering hand values
        // and using that to fold
        int nIter = 1;
        try {
