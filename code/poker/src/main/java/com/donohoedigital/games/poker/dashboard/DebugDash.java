 ...
 */
public class DebugDash extends DashboardItem implements ActionListener
{
    private GlassButton button_;

    public DebugDash(GameContext context)
    {
        super(context, "debug");
        setInDashboard(false); // by default, not visible
    }
    ...
    protected JComponent createBody()
    {
        ...
        button_ = new GlassButton("threaddump", "Glass");
