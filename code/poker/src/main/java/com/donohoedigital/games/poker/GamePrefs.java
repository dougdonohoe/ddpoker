 ...
 * GamePrefs.java
 *
 * Created on December 16, 2003, 8:18 PM
 */
...
public class GamePrefs extends OptionMenu
{
    ...
    {    
        panel_ = new GamePrefsPanel(engine_, context_, "Options", "BrushedMetal", false, this);
        data_.setBorder(BorderFactory.createEmptyBorder(0,0,0,0));
        return panel_;
    }
