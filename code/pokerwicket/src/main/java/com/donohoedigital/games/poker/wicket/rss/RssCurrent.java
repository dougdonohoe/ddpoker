...
import com.donohoedigital.games.poker.wicket.pages.online.CurrentGames;
 ...
 * @author Doug Donohoe
 */
@MountPath("rss/games/current")
public class RssCurrent extends GamesListRss
{
    ...
    {
        return WicketUtils.absoluteUrlFor(CurrentGames.class);
    }
}