 ...
 * =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
 */
package com.donohoedigital.games.poker.wicket.pages.about;
 ...
 */
public abstract class AboutPokerPage extends BasePokerPage
{
    private static final long serialVersionUID = 42L;

    public AboutPokerPage(PageParameters parameters)
    {
        super(parameters);
    }
    ...
    {
        return new AboutTopNavigation(id);
    }
