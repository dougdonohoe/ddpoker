 ...
 * @author Doug Donohoe
 */
@MountPath(path = "export/games/stopped")
public class ExportGamesStopped extends GamesListExport
{
    private static final long serialVersionUID = 42L;

    public ExportGamesStopped(PageParameters params)
    {
        super(params);
    }
