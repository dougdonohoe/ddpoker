 ...
 * @author Doug Donohoe
 */
@MountPath(path = "rss/games/completed")
public class RssRecent extends GamesListRss
{
    ...
    {
        return WicketUtils.absoluteUrlFor(RecentGames.class);
    }
}