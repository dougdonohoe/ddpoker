...
public class GameButton extends TypedHashMap
{
    ...
    /**
     * Creates a game button from the form name:gotoPhase
     */
    public GameButton(String sButtonDefinition)
    {
    ...
    {
        return "GameButton name="+sName_+", gotophase="+sGotoPhase_;
    }
    ...
    {
        if (sButtonDefinition.equals(sButtonName) ||
