 ...
 *
 */
public class UpdateCheck extends SendMessageDialog
{
    ...
    {
        String os = gamephase_.getString(EngineMessage.PARAM_PATCH_OS);
        ...
        msg.setString(EngineMessage.PARAM_PATCH_OS, os);
