...
public interface RegistrationService
{
    ...
    @Transactional(readOnly = true)
    int getMatchingRegistrationsCount(String nameSearch, String emailSearch, String keySearch, String addressSearch);

    @Transactional(readOnly = true)
    PagedList<Registration> getMatchingRegistrations(Integer count, int offset, int pagesize,
                                                String nameSearch, String emailSearch, String keySearch, String addressSearch);

    @Transactional(readOnly = true)
    List<Registration> getAllRegistrationsForKey(String sKey);

    @Transactional(readOnly = true)
    List<Registration> getBannedRegistrations();

    @Transactional(readOnly = true)
    List<RegInfo> getBannedKeys(String keyStart);

    @Transactional(readOnly = true)
    List<RegInfo> getSuspectKeys(String keyStart, int nMin);
