...
public interface OnlineGameDao extends BaseDao<OnlineGame, Long>
{
    ...
    int getByModeCount(Integer[] modes, String nameSearch, Date begin, Date end);

    OnlineGameList getByMode(Integer count, int offset, int pagesize, Integer[] modes,
    ...
    int purge(Date beforeThisDate, Integer mode);
}
