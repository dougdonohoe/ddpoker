...
public class PlaceLabel extends Label
{
    ...
    public PlaceLabel(String id)
    {
        this(id, null);
    }

    public PlaceLabel(String id, int place)
    {
        this(id, new IntegerModel(place));
    }

    public PlaceLabel(String id, IModel<Integer> model)
    {
        super(id, model);
    }
    ...
    {
        return PlaceConverter.INSTANCE;
    }
}